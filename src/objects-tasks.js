...
function compareObjects(obj1, obj2) {
  const ArrFromObj1 = Object.keys(obj1);
  const ArrFromObj2 = Object.keys(obj2);
  if (ArrFromObj1.length !== ArrFromObj2.length) {
    return false;
  }
  return ArrFromObj1.every((key) => {
    return (
...
function makeWord(lettersObject) {
  ...
  Object.keys(lettersObject).forEach((key) => {
    ...
    // TODO: filter out undefined values join into a string and return
  });
